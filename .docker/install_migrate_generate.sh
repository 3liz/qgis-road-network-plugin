...
echo '== Run SQL migrations stored in ${PLUGIN_NAME}/install/sql/upgrade/'
...
echo '== Export update database into installation SQL files'
...
echo '== Show the changes with git diff'
git diff
