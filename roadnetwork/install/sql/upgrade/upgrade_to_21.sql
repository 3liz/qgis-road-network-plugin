...
CREATE OR REPLACE FUNCTION road_graph.toggle_foreign_key_constraints(_toggle boolean DEFAULT True)
RETURNS boolean
...
COMMENT ON FUNCTION road_graph.toggle_foreign_key_constraints(_toggle boolean)
IS 'Deactivate or reactivate the foreign key constraints to ease
