...
class CreateDatabaseLocalInterface(BaseProcessingAlgorithm):
    ...
    def groupId(self):
        return 'roadnetwork_administration'
    ...
    def shortHelpString(self):
        short_help = tr(
            ...
            '\n'
            '\n'
            'The generated QGIS project must then be opened by the administrator to create the needed data by using QGIS editing capabilities'
            '\n'
            '\n'
            '* PostgreSQL connection to database: name of the database connection you would like to use for the new QGIS project.'
            '\n'
    ...
    def checkParameterValues(self, parameters, context):
        ...
        if not connection_name:
            return False, tr(
                'You must use the "Configure plugin" alg to set the database connection name'
            )
